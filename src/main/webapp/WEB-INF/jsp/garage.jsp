...
<head>
		...
		<script>
			...
			function rollback(id){
				...
				if(confirm("确认还原吗")){
					location.href="${pageContext.request.contextPath}/mail/rollback.action?id="+id;
				}
			}
			function deletemail(id){
				
				if(confirm("确认删除吗")){
					location.href="${pageContext.request.contextPath}/mail/reallydeletemail.action?id="+id;
				}
			}
		</script>
	</head>
						...
						<div class="pages">
							...
							<c:forEach items="${mails }" var="mail">
								...
								<tr align="center">
									...
									<td>${mail.create}</td>
									<td><a href="#" onclick="rollback('${mail.id }')">还原</a>|<a href="#" onclick="deletemail('${mail.id }')">删除</a></td>
								</tr>
							</c:forEach>
						</table>
